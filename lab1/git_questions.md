...
4. Why do we add `course-assignments` as a remote repository in when setting up our Git for this course (command sequence listed below)?
    ...
    ```console
    git clone https://github.com/dat320-2024/username-labs assignments
    cd assignments
    git remote add course-assignments https://github.com/dat320-2024/assignments
    ```
...
5. If the remote repositories are set up as in the following segment, how would you pull changes from the `dat320-2024/assignments` repo into the `dat320-2024/student-labs` repo you are working in?

    ```console
    course-assignments  git@github.com:dat320-2024/assignments.git (fetch)
    course-assignments  git@github.com:dat320-2024/assignments.git (push)
    origin              git@github.com:dat320-2024/student-labs.git (fetch)
    origin              git@github.com:dat320-2024/student-labs.git (push)
    ```

    - [ ] a) `git pull dat320-2024/assignments.git dat320-2024/student-labs.git`
